...
export default function PressureChart() {
  const { smoothedPressure, isVirtual } = useDeviceContext();

  /* -------------------------------------------------------
     1. Empty state
  ------------------------------------------------------- */
  if (!smoothedPressure || smoothedPressure.length === 0) {
    return (
      <div
      ...
      >
        ...
        <p className="text-gray-400 italic">No pressure data.</p>
      </div>
    );
  }
    ...
    >
      ...
      <div style={{ width: "100%", height: "260px", minHeight: "260px" }}>
        <ResponsiveContainer width="100%" height="100%">
          <LineChart data={smoothedPressure}>
            <defs>
              <linearGradient id="pressureGradient" x1="0" y1="0" x2="0" y2="1">
                <stop offset="0%" stopColor="#9c27b0" stopOpacity={0.35} />
            ...
            <Line
              type="monotone"
              dataKey="smoothed"
              stroke={isVirtual ? "#9c27b0" : "#4caf50"}
              strokeWidth={2}
              dot={false}
